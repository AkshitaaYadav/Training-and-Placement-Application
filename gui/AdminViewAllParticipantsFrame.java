...
public class AdminViewAllParticipantsFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblAllJobs.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Participant Id", "Participant Name", "Contact Number", "Email", "Skills"
            }
        ) {
    ...
    private void loadAllJobs(){
        try{
            List<ParticipantPOJO> allPtList = ParticipantDAO.getAllParticipantsForAdmin();
