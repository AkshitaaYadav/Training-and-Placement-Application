...
public class AdminRemoveHrFrame extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(318, 318, 318)
                        .addComponent(btnRemoveHr, javax.swing.GroupLayout.PREFERRED_SIZE, 243, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(317, 317, 317)
    ...
    private void btnRemoveHrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveHrActionPerformed
        ...
        int result = JOptionPane.showConfirmDialog(null, "Are you sure want to Delete " + hrId  + " from your records ?", "Confirmation", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE);
        if(result == JOptionPane.OK_OPTION){
            try{
                String userId = tblAllHr.getValueAt(row, 1).toString();
                System.out.println("trying");
                boolean ans = UsersDAO.removeHr(userId);
                System.out.println(ans);
                if(ans){
                    JOptionPane.showMessageDialog(null, "Record Deleted Successfully", "Deletion Completed", JOptionPane.INFORMATION_MESSAGE);
                    model.removeRow(row);
